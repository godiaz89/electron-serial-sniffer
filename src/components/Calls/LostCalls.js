...
class LostCalls extends React.Component {



  render(){
    const { classes } = this.props;
    console.log('Log render LostCalls: ',this.props.data);
...
LostCalls.defaultProps={
  data:[{id:'0',test:1},{id:'1',test:2}]
};

export default withStyles(styles)(LostCalls);
