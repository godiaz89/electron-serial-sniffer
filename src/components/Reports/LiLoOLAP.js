...
const REPNAME='OLAPLILO';

export default class LiLoOLAP extends React.Component {
    constructor(props){
        super(props);
        this.state={data:[],
    ...
    genLiLoOLAP=()=>{
        ...
        socketcli.genOLAPLiLo({desde:this.state.desde,hasta:this.state.hasta},result=>{
        ...
        <div>
          ...
          >
            ...
            <DialogActions>
              ...
              <Button onClick={this.genLiLoOLAP} color="primary">
                Generar
              </Button>
            </DialogActions>
          </Dialog>
